...
2. The proof of the formula for the generic character sum :
   ...
   where $\chi : (\mathbb{Z}/q \mathbb{Z})^* \rightarrow \mathbb{C}^*$
   and $\psi : (\mathbb{Z}/q \mathbb{Z})^* \rightarrow \mathbb{C}^*$ are multiplicative and additive character respectively.
