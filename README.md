...
$$ \sum_{x \in (\mathbb{Z}/p^{\alpha} \mathbb{Z})^* } \chi (f (x)) \psi (g (x)) = p^{\alpha}\sum_{{y \in (\mathbb{Z}/p^{\alpha} \mathbb{Z})^*}, \quad h(y) \equiv 0 (\mathrm{mod} \quad p^{\alpha}) } \chi{(f(y))} \psi{(g(y))} $$
